...
import { apiDeleteSocial, apiLikeSocial, apiSocialFeed, apiCommentSocial, apiEditCommentSocial } from "../api/social.api";
          ...
          <div className="space-y-3">
            ...
            <div className="pt-3 border-t text-sm">
                        ...
                        {isEditing ? (
                          <div className="mt-1 flex gap-2">
                            ...
                            <div className="flex gap-1 items-center">
                              <button onClick={() => submitEditComment(c._id)} className="text-xs text-green-600 font-semibold px-2 py-1 rounded bg-green-50 hover:bg-green-100">Save</button>
                              <button onClick={() => setEditingCommentId(null)} className="text-xs text-red-600 font-semibold px-2 py-1 rounded bg-red-50 hover:bg-red-100">Cancel</button>
                            </div>
                          </div>
                        ) : (
              ...
              <div className="flex gap-2">
                ...
                />
                <button onClick={submitComment} className="btn-primary whitespace-nowrap text-sm px-4">Post</button>
              </div>
            </div>
          </div>
        ) : null}
